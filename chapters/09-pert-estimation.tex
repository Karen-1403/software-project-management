...
\par \textbf{Standard Deviation ($\sigma$):}
\begin{equation}
\sigma = \frac{P - O}{6}
\end{equation}

\par \textbf{Variance ($\sigma^2$):}
\begin{equation}
...
\hline
\textbf{ID} & \textbf{Activity Name} & \textbf{O} & \textbf{M} & \textbf{P} & \textbf{TE} & \textbf{$\sigma$} & \textbf{$\sigma^2$} \\
...
\hline
Sum of Variances ($\Sigma\sigma^2$) & 1.79 & weeks² \\
\hline
...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Monitor High-Variance Activities:} Focus on activities with $\sigma > 0.40$
