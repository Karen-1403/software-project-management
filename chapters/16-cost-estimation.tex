...
\par Based on three-point analysis and risk considerations:

\begin{table}[H]
\centering
\caption{Final Budget Recommendation}
\begin{tabular}{|l|r|l|}
\hline
\textbf{Component} & \textbf{Amount (EGP)} & \textbf{Basis} \\
\hline
Base Project Cost & 3,400,000 & Weighted average (40\% bottom-up, 60\% market-based) \\
\hline
Management Reserve & 340,000 & 10\% for scope changes and unknowns \\
\hline
\textbf{Total Recommended Budget:} & \textbf{3,740,000} & Provides buffer while remaining realistic \\
\hline
\end{tabularx>
\end{table}

\par \textbf{Confidence Level:} 75-80\% probability of completing within this budget
